# PRD-001 Interface Contracts — toolmodel
...
| --- | --- | --- |
| `SchemaValidator` | `toolmodel/validator.go:34` | Validate(schema any, instance any) error<br/>ValidateInput(tool *Tool, args any) error<br/>ValidateOutput(tool *Tool, result any) error |
